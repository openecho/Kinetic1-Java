...
The source code can be browsed at "github":http://github.com/openecho/kinetic or in my personal "Redmine":http://jwm.slavitica.net/p/projects/java-pack/repository mirror.
