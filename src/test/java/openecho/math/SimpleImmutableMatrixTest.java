...
public class SimpleImmutableMatrixTest extends TestCase {
    ...
    public void testGetM() {
        ...
        SimpleMatrix instance = SimpleMatrix.random(m, n);
        int expResult = m;
    ...
    public void testGetRow() {
        ...
        int i = 1;
        SimpleMatrix instance = new SimpleMatrix(data);
    ...
    public void testEquals() {
        ...
        double[][] data = new double[][] {{1,2,3},{3,2,1},{1,2,3}};
        SimpleMatrix a = SimpleMatrix.random(3, 3);
    ...
    public void testAdd() {
        ...
        SimpleMatrix expResult = new SimpleMatrix(data);
        SimpleMatrix result = instance.add(b);
    ...
    public void testSubtract() {
        ...
        SimpleMatrix b = new SimpleMatrix(data);
        SimpleMatrix expResult = new SimpleMatrix(data);
        SimpleMatrix result = instance.subtract(b);
        assertTrue(expResult.equals(result));
    }
    ...
    public void testMultiply() {
        ...
        data = new double[][] {{32}};
        SimpleMatrix expResult = new SimpleMatrix(data);
        SimpleMatrix result = b.multiply(instance);
    ...
    public void testTranspose() {
        ...
        SimpleMatrix expResult = new SimpleMatrix(data);
        SimpleMatrix result = SimpleMatrix.transpose(a);
        assertTrue(expResult.equals(result));
    }
    ...
    public void testIdentity() {
        ...
        SimpleMatrix expResult = new SimpleMatrix(data);;
        SimpleMatrix result = SimpleMatrix.identity(n);
        assertTrue(expResult.equals(result));
    }
    ...
    public void testRandom_int_int() {
        ...
        int m = 3;
        int n = 3;
        SimpleMatrix result = SimpleMatrix.random(m, n);
